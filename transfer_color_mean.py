...
plt.show()
cv2.imwrite(os.path.join(save_path ,r'transfer'+'.jpg'), cv2.cvtColor(res, cv2.COLOR_BGR2RGB))
cv2.waitKey(0)
...
plt.title("WB")
plt.show()
cv2.imwrite(os.path.join(save_path ,r'wb'+'.jpg'), cv2.cvtColor(wb, cv2.COLOR_BGR2RGB))
cv2.waitKey(0)
...
plt.title("AC")
plt.show()
cv2.imwrite(os.path.join(save_path ,r'ac'+'.jpg'), cv2.cvtColor(ac, cv2.COLOR_BGR2RGB))
cv2.waitKey(0)
